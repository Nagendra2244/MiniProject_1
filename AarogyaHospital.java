...
class AarogyaHospital{
	...
	class AarogyaMember{
	    ...
	    public void input(){
            ...
            sc.nextLine();
            while(age<1||age>100){
                System.out.println("Enter valid age between 1 to 100");
                age=sc.nextInt();
                sc.nextLine();
            }
            

            System.out.print("Enter the Patient Gender:(M/F) ");
            gender=sc.nextLine();
            ...
            System.out.print("Enter the Patient Aadhar Card Number: ");
            ...
            System.out.print("Enter Date of Patient Admission: ");
            ...
            System.out.print("Enter The Patient Guardian Name: ");
            guardianName = sc.nextLine();

            System.out.print("Enter the Patient Guardian Address: ");
            guardianAddress=sc.nextLine();

            System.out.print("Enter the Patient Guardian Contact Number: ");
